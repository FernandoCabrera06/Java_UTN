...
public class DAOProfesor extends DAOConexion {
    ...
    public ArrayList<Modelo.Profesor> traeProfesoresDAO() {
    ...
    public Modelo.Profesor traeUNProfesorDAO(Integer dni) {
    ...
    public boolean cargaDatosDAO(Modelo.Profesor profesor) {
        try {
            this.conectar();
    ...
    public boolean modificaDAO(Modelo.Profesor profesor) {
        try {
            this.conectar();
    ...
    public boolean dniExisteDAO(Modelo.Profesor profesor) {
